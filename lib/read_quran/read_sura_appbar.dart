...
class _ReadSuraAppBarState extends State<ReadSuraAppBar> {
  ...
  Widget build(BuildContext context) {
    return AppBar(
      title: FittedBox(
        fit: BoxFit.contain,
        child: Text(quranProvider.selectedTranslation == 'pj'
            ? SuraDetails
                .suraListPj[quranProvider.selectedSuraNumber - 1].tamilName
            : SuraDetails
                .suraListAll[quranProvider.selectedSuraNumber - 1].tamilName),
      ),
              ...
              children: <Widget>[
                ...
                Flexible(
                  child: SingleChildScrollView(
                    child: Text(
                      SuraDetails
                          .suraListPj[quranProvider.selectedSuraNumber - 1]
                          .reasonForName!,
                      style: const TextStyle(
                        fontSize: 18,
                      ),
