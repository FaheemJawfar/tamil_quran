...
class _SettingsState extends State<Settings> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('அமைப்புகள்',style: TextStyle(
      ...
      SingleChildScrollView(
          child: Container(
            ...
            crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                 Text('மொழிபெயர்ப்பைத் தெரிவு செய்யுங்கள்:',style: TextStyle(
                   fontSize: 16,
                ...
                ListTile(
                 ...
                 contentPadding: EdgeInsets.only(top: 2,bottom: 2),
                  ...
                  title: Text('ஜான் அறக்கட்டளை (John Trust)',style: TextStyle(
                    fontSize: 15,
                    fontFamily: _selectedTamilFont,
                  ),),
                ),
                ...
                ListTile(
                  ...
                  title: Text('மன்னர் பஹத் வளாகம் (சவூதி)',style: TextStyle(
                    fontSize: 15,
                    fontFamily: _selectedTamilFont,
                  ),),
                ),
                ...
                ListTile(
                  ...
                  title: Text('பீ. ஜைனுலாப்தீன் (PJ)',style: TextStyle(
                    fontSize: 15,
                    fontFamily: _selectedTamilFont,
                  ),),
                ),
                ...
                ListTile(
                  ...
                  title: Text('இஸ்லாமிய நிறுவனம் அறக்கட்டளை (IFT)',style: TextStyle(
                    fontSize: 15,
                    fontFamily: _selectedTamilFont,
                  ),),
                ),
                ...
                ListTile(
                  ...
                  title: Text('அப்துல் ஹமீது பாகவி',style: TextStyle(
                    fontSize: 15,
                    fontFamily: _selectedTamilFont,
                  ),),
                ),
            ...
            Text('அரபு எழுத்துரு அளவு',style: TextStyle(
              fontSize: 16,
              fontWeight: FontWeight.bold,
              fontFamily: _selectedTamilFont,
            ...
            Slider(
              ...
              onChanged: (double value) async {
                ...
                Text('தமிழ் எழுத்துரு அளவு',style: TextStyle(
                  fontSize: 16,
                  fontWeight: FontWeight.bold,
                  fontFamily: _selectedTamilFont,
                ...
                Text('தமிழ் எழுத்து வடிவத்தை தேர்வு செய்க:',style: TextStyle(
                  fontSize: 16,
                  fontWeight: FontWeight.bold,
                  fontFamily: _selectedTamilFont,
                ...
                Text('அரபு எழுத்து வடிவத்தை தேர்வு செய்க:',style: TextStyle(
                  fontSize: 16,
                  fontWeight: FontWeight.bold,
                  fontFamily: _selectedTamilFont,
